...
(function() {
  var app, magnitudeControl, myslide, root, sidebar, sidebarControl, xhr_url;
  ...
  d3.json(xhr_url, function(error, collection) {
    ...
    app.graph_svg.selectAll(".dot").data(collection.features).enter().append("circle").attr("class", "dot").attr("r", 3.5).attr("cx", function(d) {
